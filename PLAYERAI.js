...
function readEnemyPatterns(player, enemies, maplayout, end, process)
{
	...
	for(var ctr = 0; ctr < enemies.length; ctr++)
	{
		...
		for (var ctr2 = 0; ctr2 < details.length; ctr2++) {
			enemyPatterns.push(details[ctr2]);
		...
		console.log("X is \n");
		console.log(enemyPatterns[0] + "\n");
		console.log("Y is \n");
		console.log(enemyPatterns[1] + "\n");
		console.log("X is \n");
		console.log(enemyPatterns[4] + "\n");
		console.log("Y is \n");
		console.log(enemyPatterns[5] + "\n");
		console.log("X is \n");
		console.log(enemyPatterns[8] + "\n");
		console.log("Y is \n");
		console.log(enemyPatterns[9] + "\n");}
